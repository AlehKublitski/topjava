...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_I18N_MAP = new HashMap<String, String>(){{put("users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL); put("meals_unique_user_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);}};
